...
const ANIMALS: readonly (readonly [name: string, gender: Gender])[] = [
  ['שועל', 'm'], ['חתול', 'm'], ['כלב', 'm'], ['דביבון', 'm'], ['ברווז', 'm'],
  ['ינשוף', 'm'], ['פינגווין', 'm'], ['קואלה', 'f'], ['פנדה', 'f'], ['קפיברה', 'f'],
  ['ארנב', 'm'], ['קוף', 'm'], ['לוטרה', 'f'], ['נשר', 'm'], ['פלמינגו', 'm'],
  ["ג'ירפה", 'f'], ['פיל', 'm'], ['זברה', 'f'], ['טווס', 'm'], ['כריש', 'm'],
  ['לוויתן', 'm'], ['תמנון', 'm'], ['צב', 'm'], ['דולפין', 'm'], ['למור', 'm'],
] as const

const TRAITS: readonly Inflected[] = [
  ['סקרן', 'סקרנית'], ['שובב', 'שובבה'], ['מסתורי', 'מסתורית'], ['נועז', 'נועזת'],
  ['רגוע', 'רגועה'], ['זריז', 'זריזה'], ['שנון', 'שנונה'], ['חייכן', 'חייכנית'],
  ['עקשן', 'עקשנית'], ['מנומס', 'מנומסת'], ['מבולבל', 'מבולבלת'], ['דרמטי', 'דרמטית'],
  ['ספונטני', 'ספונטנית'], ['יצירתי', 'יצירתית'], ['חולם', 'חולמת'],
  ['הרפתקן', 'הרפתקנית'], ['פיקח', 'פיקחית'], ['עצלן', 'עצלנית'],
  ['אופטימי', 'אופטימית'], ['ציני', 'צינית'], ['שקט', 'שקטה'], ['אנרגטי', 'אנרגטית'],
  ['קלאסי', 'קלאסית'], ['מוזר', 'מוזרה'], ['אגדי', 'אגדית'],
] as const

/** Nouns such as זהב and תכלת keep one form for both genders. */
const COLOURS: readonly Inflected[] = [
  ['כחול', 'כחולה'], ['תכלת', 'תכלת'], ['סגול', 'סגולה'], ['ורוד', 'ורודה'],
  ['אדום', 'אדומה'], ['כתום', 'כתומה'], ['צהוב', 'צהובה'], ['ירוק', 'ירוקה'],
  ['טורקיז', 'טורקיז'], ['זהב', 'זהב'], ['כסף', 'כסף'], ['לבן', 'לבנה'],
  ['שחור', 'שחורה'], ['אפור', 'אפורה'], ['בורדו', 'בורדו'], ['לילך', 'לילך'],
  ['מנטה', 'מנטה'], ['קורל', 'קורל'], ['אינדיגו', 'אינדיגו'], ["מג'נטה", "מג'נטה"],
] as const

const OBJECTS: readonly string[] = [
  'מטרייה', 'כובע', 'משקפיים', 'מזוודה', 'מצפן', 'פנס', 'שעון', 'מצלמה',
  'בלון', 'עפיפון', 'מטרונום', 'מיקרופון', 'גיטרה', 'פסנתר', 'טוסטר', 'קומקום',
  'ספל', 'כפית', 'מזלג', 'כרית', 'גרב', 'נעלי בית', 'סקייטבורד', 'אופניים',
  'רדיו', 'טלסקופ', 'מגפון', 'פנקס', 'משרוקית',
] as const
