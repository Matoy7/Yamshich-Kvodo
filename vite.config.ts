...
export default defineConfig(({ mode }) => {
  ...
  return {
    // GitHub Pages serves the built site from a sub-path (e.g. /REPO_NAME/),
    // not the domain root. A relative base makes every generated asset URL
    // resolve correctly regardless of the repository name/path it's hosted
    // under, without hard-coding it here.
